                        ...
                        <tbody >
                            ...
                            <c:forEach items="${sessionScope.Cart}" var="cart" varStatus="loop">
                                <tr class="table-info">
                                    ...
                                    <th>${cart.getAmmount()} Ammount</th>
                                    <th>${helper.convertBigNum(cart.getAmmount()*cart.getPrice())}</th>

                                    <th>
                                        <a href="cart?aid=${cart.getAccountId()}&pid=${cart.getProductId()}&buy=1"><button style="background-color: greenyellow"  type="button" class="btn">Buy</button></a>
                                        <a href="cart?aid=${cart.getAccountId()}&pid=${cart.getProductId()}&del=1"><button style="background-color: red" type="button" class="btn text-black    ">Delete</button></a>
                                    </th>
                                </tr>
                            </c:forEach>
                        </tbody>
                            ...
                            <div class="card-body mx-4">
                                <div class="container">
                                    ...
                                    <c:forEach items="${sessionScope.Cart}" var="cart">
                                        ...
                                        <div class="row">
                                            <div class="col-xl-10">
                                                <p>${cart.getAmmount()} vé ${cart.getProductName()}</p>
                                            </div>
                                            <div class="col-xl-2">
