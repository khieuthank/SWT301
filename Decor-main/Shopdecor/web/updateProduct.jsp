    ...
    <body>
        ...
        <div class="container" style="padding: 80px;">
            <form method="post" action="updateProduct">
                ...
                <div class="mb-3">
                    <label for="" class="form-label">Decor</label>
                ...
                <div class="mb-3">
                    <label for="imgInput" class="form-label">ImageLink</label>
                    <input name="img" value="${pU.img}" class="form-control" id="imgInput">
                    <img id="imgPreview" src="${pU.img}" alt="Ảnh">
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input name="description" value="${pU.getDescription()}" type="text" class="form-control" id="" required>
                </div>
